...
<head>
    ...
    <title>Edit User - {{ session('current_company')->name ?? 'HSE System' }}</title>
        ...
        <main class="py-8">
            <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Update user information for {{ $user->name }}</p>
                </div>
                        ...
                        <div class="mb-6">
                            ...
                            <select name="role_id" id="role_id" required
                                ...
                                @foreach($roles as $role)
                                    <option value="{{ $role->id }}" {{ old('role_id', $user->companies->where('id', session('current_company_id'))->first()?->pivot?->role_id) == $role->id ? 'selected' : '' }}>
                                        {{ $role->name }}
                                    </option>
                                @endforeach
                            </select>
