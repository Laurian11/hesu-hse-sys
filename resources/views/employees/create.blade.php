...
<head>
    ...
    <title>Create Employee - {{ session('current_company')->name ?? 'HSE System' }}</title>
    ...
    <div class="min-h-screen">
        ...
        <main class="py-8">
            <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Header -->
                <div class="mb-6">
                    <h2 class="text-2xl font-bold text-gray-900">Create New Employee</h2>
                    <p class="mt-1 text-sm text-gray-600">Add a new employee to {{ $company->name }}</p>
                </div>
