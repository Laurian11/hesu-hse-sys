...
<head>
    ...
    <title>Edit Department - {{ session('current_company')->name ?? 'HSE System' }}</title>
        ...
        <main class="py-8">
            <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Update department information for {{ $department->name }}</p>
                </div>
