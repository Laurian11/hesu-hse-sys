...
<head>
    ...
    <title>Create Company - HSE System</title>
        ...
        <main class="py-8">
            <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Add a new company to the HSE system</p>
                </div>

                <!-- Form -->
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form method="POST" action="{{ route('companies.store') }}" enctype="multipart/form-data" class="p-6">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="logo" id="logo" accept="image/*"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            <p class="mt-1 text-sm text-gray-500">Upload a logo image (PNG, JPG, etc.)</p>
                            @error('logo')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
